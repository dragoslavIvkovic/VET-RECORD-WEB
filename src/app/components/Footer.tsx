                ...
                <div className="flex flex-col items-end gap-4 md:flex-row md:items-center md:justify-end">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="relative">
                            ...
                            <button
                                type="submit"
                                className="absolute right-2 top-1/2 -translate-y-1/2 font-bold text-[#0C4C55]"
                        ...
                        >
                            <div className="mb-3 flex items-center gap-3">
                                <img
                                    ...
                                    className="flex h-16 w-16 shrink-0 rounded-lg object-cover"
                                />
                                <div className="min-w-0 flex-1">
                                    <h3 className="m-0 truncate text-lg font-semibold leading-tight text-gray-900">
                                        Vet Record
                                    </h3>
                ...
                <div className="container mx-auto px-4">
                    <div className="flex flex-wrap items-center justify-between gap-4 text-sm text-gray-300">
                        ...
                        <ul className="flex flex-wrap gap-4">
                            <li>
                                <LocalizedLink href="/" className="hover:text-white">
                                    {t('footer.home')}
                                </LocalizedLink>
                            </li>
                            <li>
                                <LocalizedLink href="/about" className="hover:text-white">
                                    {t('footer.about')}
                                </LocalizedLink>
                            </li>
                            <li>
                                <LocalizedLink href="/privacy-policy" className="hover:text-white">
                                    {t('footer.privacy')}
                                </LocalizedLink>
                            </li>
                            <li>
                                <LocalizedLink href="/contact" className="hover:text-white">
                                    {t('footer.contact')}
                                </LocalizedLink>
                            </li>
                        </ul>
