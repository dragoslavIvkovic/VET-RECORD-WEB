        ...
        <div className='relative container'>
            <div className='grid grid-cols-1 pb-6 text-center'>
                ...
                <p className='mx-auto max-w-xl text-slate-400'>
                    Looking for a smarter way to manage your pet's health and wellness? Vet Record is the complete pet
                    care organizer that puts your furry friend's health records at your fingertips.
                </p>
            </div>
                        ...
                        <div className='group flex duration-500 xl:p-3'>
                            ...
                            <div className='order-2 ms-4 flex-1 md:order-1 md:ms-0 md:me-4 md:text-end'>
                                ...
                                <p className='mt-3 text-slate-400'>
                                    Track all aspects of your pet's health and wellness with detailed medical records
                                    and analytics
                                </p>
                            </div>
                        </div>
